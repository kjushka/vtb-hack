...
type ArticleRepository interface {
	...
	SaveArticle(ctx context.Context, art *article.Article) error
...
func (pr *articleRepository) GetProduct(ctx context.Context, productID int64) (*product_model.Product, error) {
...
func (pr *articleRepository) getProductComments(ctx context.Context, productID int64) ([]product_model.Comment, error) {
...
func (pr *articleRepository) SaveArticle(ctx context.Context, art *article.Article) error {
	ctx, cancel := context.WithTimeout(ctx, time.Second*15)
	defer cancel()

	_, err := pr.db.ExecContext(ctx,
		`
		insert into articles (article_text, , preview, product_count, price, description, in_nft)
...
func (pr *articleRepository) GetAllProducts(ctx context.Context) ([]product.Product, error) {
	ctx, cancel := context.WithTimeout(ctx, time.Second*15)
	defer cancel()
...
func (pr *articleRepository) GetProductsByIDs(ctx context.Context, productsIds []int64) ([]product.Product, error) {
	ctx, cancel := context.WithTimeout(ctx, time.Second*15)
	defer cancel()
...
func (prRep *articleRepository) UpdateProduct(ctx context.Context, productId int64, pr *product.Product) (*product.Product, error) {
	ctx, cancel := context.WithTimeout(ctx, time.Second*15)
	defer cancel()
...
func (pr *articleRepository) DeleteProduct(ctx context.Context, productID int64) error {
	ctx, cancel := context.WithTimeout(ctx, time.Second*15)
	defer cancel()
...
func (pr *articleRepository) MakePurchase(ctx context.Context, p *product.Product, customerID, amount int64) error {
	ctx, cancel := context.WithTimeout(ctx, time.Second*15)
	defer cancel()
...
func (pr *articleRepository) GetUserProducts(ctx context.Context, userID int64) ([]product.Product, error) {
	ctx, cancel := context.WithTimeout(ctx, time.Second*15)
	defer cancel()
...
func (pr *articleRepository) GetUserPurchases(ctx context.Context, userID int64) ([]product.Purchase, error) {
	ctx, cancel := context.WithTimeout(ctx, time.Second*15)
	defer cancel()
